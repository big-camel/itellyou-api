...
public interface QuestionCommentDao {
    int insert(QuestionCommentModel commentModel);

    QuestionCommentModel findById(Long id);

    List<QuestionCommentModel> search(@Param("ids") Collection<Long> ids, @Param("questionId") Long questionId, @Param("parentIds") Collection<Long> parentIds, @Param("replyId") Long replyId, @Param("userId") Long userId,
    ...
    int count(@Param("ids") Collection<Long> ids, @Param("questionId") Long questionId, @Param("parentIds") Collection<Long> parentIds, @Param("replyId") Long replyId, @Param("userId") Long userId,
                    @Param("isDeleted") Boolean isDeleted,
                    @Param("minComment") Integer minComment, @Param("maxComment") Integer maxComment,
                    @Param("minSupport") Integer minSupport, @Param("maxSupport") Integer maxSupport,
                    @Param("minOppose") Integer minOppose, @Param("maxOppose") Integer maxOppose,
    ...
    List<QuestionCommentModel> searchChild(@Param("ids") Collection<Long> ids, @Param("questionId") Long questionId, @Param("parentIds") Collection<Long> parentIds, @Param("replyId") Long replyId, @Param("userId") Long userId,
                                                 @Param("isDeleted") Boolean isDeleted,
