...
public class GeetestServiceImpl implements GeetestService {
    ...
    private final ConfigDefaultService<GeetestConfigModel> geetestConfigService;

    private final GeetestLogService geetestLogService;

    public GeetestServiceImpl(GeetestConfigDefaultServiceImpl geetestConfigService, GeetestLogService geetestLogService) {
    ...
    public GeetestModel init(String mode, Long userId, GeetestClientTypeEnum clientType, String ip){
        ...
        GeetestConfigModel configModel = geetestConfigService.getDefault();
