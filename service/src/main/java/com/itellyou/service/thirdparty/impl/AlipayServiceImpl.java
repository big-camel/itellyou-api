...
public class AlipayServiceImpl implements AlipayService {
    ...
    private final ConfigDefaultService<AliPayConfigModel> configDefaultService;

    public AlipayServiceImpl(AlipayConfigDefaultServiceImpl configServer) {
        this.configDefaultService = configServer;
    }

    @Override
    public AlipayClient getDefaultAlipayClient() throws Exception {
        AliPayConfigModel configModel = configDefaultService.getDefault();
