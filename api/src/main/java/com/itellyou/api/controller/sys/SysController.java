...
public class SysController {
    ...
    public SysController(SysPermissionService permissionService, SysSettingService settingService, SysLinkService linkService, UserSearchService userSearchService) {
    ...
    @GetMapping("/init")
    public ResultModel init(UserInfoModel userModel,@RequestParam(required = false) String p) throws InstantiationException, IllegalAccessException {
