...
public class QuestionCommentController {
    ...
    public Result root(UserInfoModel userModel, @PathVariable Long questionId,@RequestParam(required = false) Integer offset, @RequestParam(required = false) Integer limit){
        ...
        List<QuestionCommentDetailModel> hostList = commentSearchService.search(questionId,null,searchUserId,null,null,null,null,3,null,null,null,null,null,
                order,0,10);
        int newOffset = 0;
        int newLimit = 0;
        ...
        // 查询评论
        PageModel<QuestionCommentDetailModel> pageData = commentSearchService.page(questionId,0L,searchUserId,null,2,null,null,null,null,null,null,null,null,
    ...
    public Result child(UserInfoModel userModel, @PathVariable Long questionId,@PathVariable Long id, @RequestParam(required = false) boolean hasDetail, @RequestParam(required = false) Integer offset, @RequestParam(required = false) Integer limit){
        ...
        // 查询评论
        PageModel<QuestionCommentDetailModel> pageData = commentSearchService.page(questionId,id,searchUserId,null,null,null,null,null,null,null,null,null,null,
                null,offset,limit);
        if(hasDetail){
            QuestionCommentDetailModel commentDetail = commentSearchService.getDetail(id,questionId,null,null,searchUserId,null,null);
            Map<String,Object> extendData = new HashMap<>();
